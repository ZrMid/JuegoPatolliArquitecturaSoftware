...
public class InternalFrmCrearPartida extends javax.swing.JInternalFrame {

    FrmMainPanel objMainPanel;

    public InternalFrmCrearPartida(FrmMainPanel objMainPanel) {
        initComponents();
    ...
    private void btnCrearPartidaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCrearPartidaMouseClicked
        int resp = JOptionPane.showConfirmDialog(this, "Una vez creado no podra retroceder.\nDesea Continuar?", "Confirmacion", JOptionPane.YES_NO_OPTION);
        if (resp == JOptionPane.YES_OPTION) {
            objMainPanel.crearConfiguracionPartida(Integer.parseInt(lblNoJugadores.getText()),
                    Integer.parseInt(lblNoCasillasAspa.getText()), Integer.parseInt(lblNoFichas.getText()), Integer.parseInt(lblNoFrijoles.getText()));

            objMainPanel.crearServer(12345);

            objMainPanel.agregarInternalFrmUnirsePartida("Admin");
        }
